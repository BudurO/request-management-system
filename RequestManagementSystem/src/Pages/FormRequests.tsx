...
{error && <p className="error-message">{error}</p>}
  ...
  <h2 className="lg:text-3xl lg:text-center lg:mb-10 text-[#901DFF] xl:text-3xl xl:text-center mb-10 mt-4">Create a Request:</h2>
    ...
    <div className="">
      ...
      <div className="py-3">
      <a href="/dashboard" className="rounded-md bg-gray-400 hover:bg-gray-300 py-4 px-8 text-center text-base font-semibold text-white outline-none">
              Request Details 
      </a>
      </div>
    </div>
