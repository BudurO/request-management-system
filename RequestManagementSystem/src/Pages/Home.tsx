    ...
    <>
      ...
      <div className="bg-white">
        <div className="flex justify-between items-center py-28 ">
          <div className="lg:w-5/6 px-5 lg:text-center">
            <h2 className="lg:max-w-2xl lg:text-7xl font-semibold text-[#5F00CD] pt-20">
              <span className=" text-black">Make</span>
              <span>
                {" "}
                <span className=" text-black">All things</span>
                <Typewriter
                  options={{
                    strings: ["Creative things", "Beautiful things"],
                    autoStart: true,
                    loop: true,
                  }}
                />
              </span>{" "}
              <span className="text-black">things Every Day</span>
            </h2>
            <p className="text-gray-600 mt-4 pt-20">
              {" "}
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Molestias quisquam nobis a harum repellat? Ipsum labore, vero
              optio laborum cupiditate minus vel accusantium facere quae ducimus
              repellendus architecto vitae saepe.
            </p>
          </div>
          <div className="w-1/2">
            <img src={ImgSystem} alt="" className="w-full h-auto lg:mx-20" />
            <div className="mt-8 flex flex-col space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
              <input
                id="email"
                type="text"
                className="rounded-md border-solid  border-2 shadow-inner px-4 py-2 text-black placeholder-gray backdrop-blur-sm focus:border-[#901DFF] focus:outline-none focus:ring focus:ring-[#901DFF] focus:ring-opacity-40 sm:mx-2"
                placeholder="Email Address"
              />

              <button className="transform rounded-md  bg-[#901DFF] hover:bg-[#5F00CD] px-8 py-2 text-sm font-medium capitalize tracking-wide text-white transition-colors duration-200 focus:outline-none sm:mx-2">
                Notify Me
              </button>
            </div>
          </div>
      ...
      <section id="Contact">
          ...
          <div className="w-full draggable">
            <div className="container flex flex-col items-center gap-16 mx-auto my-32">
              <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main border-solid border-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700">
                  <span>
                    <svg
                  ...
                  <a
                    ...
                    href="mailto:buduralthubyani@gmail.com"
                  >
                    buduralthubyani@gmail.com
                  </a>
                </div>
                <div className="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl shadow-main border-solid border-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700">
                  <span>
        ...
        <div className="bg-gradient-to-r from-[#5F00CD] to-[#935bd7] p-10  mt-10">
          <p className="text-white mt-2 text-center">
            Copyright, System Company 2030, All rights reserved.
          </p>
        </div>
      </section>
    </>
